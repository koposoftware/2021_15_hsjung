	                        ...
	                        <div class="blog-item">
	                            ...
	                            <div class="bi-text" >
	                              ...
	                              <%--   <ul>
	                                ...
	                                <form>
	                                <a style="float:right;"href="${pageContext.request.contextPath}/member/addMemberAccount?accountSq=${accounts.accountSq}&memberSq=${member.memberSq}" class="read-more">해당 계좌 선택하기<span class="arrow_right"></span></a>
	                                </form>
	                            </div>
	                        </div>
                        </c:forEach>
