...
<html lang="UTF-8" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section i${pageContext.request.contextPath}/addDeliveryd="home">
        <div class="bg-holder" style="background-image:url(${pageContext.request.contextPath}/resources/assets/img/gallery/header-bg.png);background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row align-items-center min-vh-50 min-vh-sm-100">
            <div class="col-md-7 col-lg-6 text-md-start text-center">
              <h1 class="text-light fs-6 fs-xl-8 font-cursive fw-normal mb-5">현-SSG 택배에 <br />오신 것을<br /> 환영합니다.</h1>
                <a class="btn btn-primary" href="#addStatus" role="button">택배 조회
                ...
                <div class="card-body"> 
                  <form class="row g-3 align-items-center">
                    <div class="mb-3">
                      ...
                      <input class="form-control form-traffico-control" id="formGroupExampleInput2" type="text" placeholder="운송장 번호를 입력해 주세요" />
                    </div>
                    <div class="col-12">
                      <button class="btn btn-primary" type="submit">조회하기
